...
public class HangmanMenuPanel extends JPanel {
    ...
    public HangmanMenuPanel(HangmanMenuFrame menuFrame) {
        ...
        lblWelcome.setBounds(0, Constants.HEIGHT_BUTTONS * 2 - Constants.MID_SCREEN_Y, Constants.SCREEN_X,
                Constants.SCREEN_Y);

        // play button
        JButton btnPlay = new JButton("Play");
        btnPlay.setFont(Constants.FONT(20));
        btnPlay.setBounds(Constants.MID_SCREEN_X - Constants.WIDTH_BUTTONS,
                Constants.MID_SCREEN_Y - Constants.HEIGHT_BUTTONS * 2 - Constants.VERTICAL_GAP_BUTTONS,
                Constants.WIDTH_BUTTONS * 2, Constants.HEIGHT_BUTTONS * 2);
        ...
        btnQuestManager.setBounds(Constants.MID_SCREEN_X - Constants.WIDTH_BUTTONS, Constants.MID_SCREEN_Y,
                Constants.WIDTH_BUTTONS * 2, Constants.HEIGHT_BUTTONS * 2);
        ...
        btnBackToMenu.setBounds(Constants.MID_SCREEN_X - Constants.WIDTH_BUTTONS,
                Constants.MID_SCREEN_Y + Constants.HEIGHT_BUTTONS * 2 + Constants.VERTICAL_GAP_BUTTONS,
                Constants.WIDTH_BUTTONS * 2, Constants.HEIGHT_BUTTONS * 2);
